...
export default function Contact() {
  ...
  try {
    const response = await fetch("https://gentlemen-excursions.onrender.com/api/contact", {
      method: "POST",
      headers: {
      ...
      body: JSON.stringify({
        ...
        language, // utile pour email multilingue plus tard
      }),
    });
  ...
  return <Layout>
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={merEmeraudeImg3} alt="Contact Gentlemen Excursions" className="w-full h-full object-cover" />
...
<div className="pt-8 border-t border-zinc-800">
  ...
  <div className="flex gap-3">
    {['facebook', 'instagram', 'youtube'].map(social => {
      // Configuration des liens ici
      const links = {
        facebook: "https://web.facebook.com/profile.php?id=100064142230041",
        instagram: "https://www.instagram.com/fabienbarthezgentleman?igsh=eGF0MGl0ajdmNXJu",
        youtube: "https://youtube.com/@gentlemenexcursion?si=Oy-cTgJb5w_76kg0"
      };
